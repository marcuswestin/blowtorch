...
typedef void (^BTRequestHandler)(NSDictionary* params, WVPResponse* response);
    ...
    #define BTSharedApplication [NSApplication sharedApplication]
#elif defined __IPHONE_OS_VERSION_MAX_ALLOWED
    #define BT(thing) UI##thing
    ...
    #define BTSharedApplication [UIApplication sharedApplication]
#endif
